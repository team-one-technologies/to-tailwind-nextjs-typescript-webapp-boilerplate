        ...
        <ul className="space-y-2">
          ...
          <li>
            ...
            >
              ...
              <span className="inline-flex items-center justify-center px-2 ml-3 text-sm font-medium text-gray-800 bg-red-400 rounded-full dark:bg-gray-700 dark:text-gray-300">
                Pro
              </span>
            </a>
          </li>
          ...
          <li>
            ...
            >
              ...
              <span className="flex-1 ml-3 whitespace-nowrap">Fields</span>
            </a>
          </li>
          <li>
            <a
            ...
            >
              ...
              <span className="flex-1 ml-3 whitespace-nowrap">Champions</span>
            </a>
          </li>
          <li>
            <a
